...
contains
   ...
   &sbufmat  ,sdir_a   ,sdir_b   ,stf,nparg,snpc,dt)
!-----------------------------------------------
!   m o d u l e s
!-----------------------------------------------
      use constant_mod
...
!
      ...
      my_real ,dimension(mvsiz) :: fpsxx,fpsyy,fpszz,fpsxy,fpsyx,epchk,epspdt,dt_inv,&
      &                            copy_pla,pla0,degmb ,degfx ,sigoff,thklyl,thkn  , &
      &                            etse,off_old,depsxx,depsyy,depsxy,depsyz,depszx,epsxx ,epsyy ,epsxy, &
...
!
      ...
      my_real tt_local
      my_real, dimension(:) ,pointer  :: el_temp,yldfac,crklen,crkdir,dadv,tfail,el_len,el_pla
